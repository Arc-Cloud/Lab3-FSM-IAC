...
VL_ATTR_COLD void VF1_Lights___024root___initial__TOP__0(VF1_Lights___024root* vlSelf) {
    ...
    // Body
    vlSelf->F1_Lights__DOT__Delay__DOT__count = 0U;
    vlSelf->F1_Lights__DOT__f1_fsm_en = 0U;
}
...
VL_ATTR_COLD void VF1_Lights___024root___settle__TOP__0(VF1_Lights___024root* vlSelf) {
    ...
    if (((((((((0U == vlSelf->F1_Lights__DOT__ClkTick__DOT__F1FSM__DOT__current_state) 
        ...
        if ((0U == vlSelf->F1_Lights__DOT__ClkTick__DOT__F1FSM__DOT__current_state)) {
            ...
            vlSelf->F1_Lights__DOT__ClkTick__DOT__data_out 
                = ((1U == vlSelf->F1_Lights__DOT__ClkTick__DOT__F1FSM__DOT__current_state)
                    ? 1U : ((2U == vlSelf->F1_Lights__DOT__ClkTick__DOT__F1FSM__DOT__current_state)
                             ? 3U : ((3U == vlSelf->F1_Lights__DOT__ClkTick__DOT__F1FSM__DOT__current_state)
                                      ? 7U : ((4U == vlSelf->F1_Lights__DOT__ClkTick__DOT__F1FSM__DOT__current_state)
                                               ? 0xfU
                                               : ((5U 
    ...
    if (((((((((0U == vlSelf->F1_Lights__DOT__ClkTick__DOT__F1FSM__DOT__current_state) 
        ...
        } else if (vlSelf->F1_Lights__DOT__cmd_seq) {
...
VL_ATTR_COLD void VF1_Lights___024root___ctor_var_reset(VF1_Lights___024root* vlSelf) {
    ...
    vlSelf->F1_Lights__DOT__tick = VL_RAND_RESET_I(1);
    vlSelf->F1_Lights__DOT__cmd_seq = VL_RAND_RESET_I(1);
    vlSelf->F1_Lights__DOT__cmd_delay = VL_RAND_RESET_I(1);
    vlSelf->F1_Lights__DOT__f1_fsm_en = VL_RAND_RESET_I(1);
    vlSelf->F1_Lights__DOT__LFSR__DOT__sreg = VL_RAND_RESET_I(7);
    vlSelf->F1_Lights__DOT__ClkTick__DOT__data_out = VL_RAND_RESET_I(8);
    vlSelf->F1_Lights__DOT__ClkTick__DOT__count = VL_RAND_RESET_I(5);
    vlSelf->F1_Lights__DOT__ClkTick__DOT__F1FSM__DOT__trigger = VL_RAND_RESET_I(1);
    vlSelf->F1_Lights__DOT__ClkTick__DOT__F1FSM__DOT__cmd_seq = VL_RAND_RESET_I(1);
    vlSelf->F1_Lights__DOT__ClkTick__DOT__F1FSM__DOT__cmd_delay = VL_RAND_RESET_I(1);
    vlSelf->F1_Lights__DOT__ClkTick__DOT__F1FSM__DOT__current_state = 0;
    vlSelf->F1_Lights__DOT__ClkTick__DOT__F1FSM__DOT__next_state = 0;
    vlSelf->F1_Lights__DOT__Delay__DOT__count = VL_RAND_RESET_I(7);
    vlSelf->F1_Lights__DOT__Delay__DOT__current_state = 0;
    vlSelf->F1_Lights__DOT__Delay__DOT__next_state = 0;
    vlSelf->F1_Lights__DOT__F1FSM__DOT__current_state = 0;
    vlSelf->F1_Lights__DOT__F1FSM__DOT__next_state = 0;
    vlSelf->__Vdly__F1_Lights__DOT__LFSR__DOT__sreg = VL_RAND_RESET_I(7);
